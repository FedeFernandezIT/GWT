...
public class StockWatcher implements EntryPoint {
	private static final int REFRESFH_INTERVAL = 5000; // milliseconds.

	// JSON_URL:  http://localhost:8080/stockwatcher/stockPrice?q=
	// HOST: http://localhost:8080
	// URL BASE: /stockwatcher/
	// URL_PATTERN: stockPrice
	private static final String JSON_URL = GWT.getModuleBaseURL() + "stockPrice?q=";
	...
	public void onModuleLoad() {
		...
		stocksFlexTable.getCellFormatter().addStyleName(0, 1, "wacthListNumericColumn");
		...
		refreshTimer.scheduleRepeating(REFRESFH_INTERVAL);
	}
	...
	private void addStock() {
		...
		stocksFlexTable.getCellFormatter().addStyleName(row, 1, "wacthListNumericColumn");
