...
public class Main_MainUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, org.gwtproject.tutorial.client.Main>, org.gwtproject.tutorial.client.Main.MainUiBinder {
  ...
  class Widgets {
    ...
    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.menuClearAll((com.google.gwt.event.dom.client.ClickEvent) event);
      }
    };

    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames4 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.menuClearDone((com.google.gwt.event.dom.client.ClickEvent) event);
      }
    };
    ...
    private com.vaadin.polymer.paper.widget.PaperIconItem build_menuClearAll() {
      ...
      // Setup section.
      menuClearAll.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3);
    ...
    private com.vaadin.polymer.paper.widget.PaperIconItem build_menuClearDone() {
      ...
      // Setup section.
      menuClearDone.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames4);
